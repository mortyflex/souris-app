...
Agent instructions live at the repo root — `AGENTS.md` / `AGENTS.md`, with project skills under `.Codex/`. Other config and assets stay outside `src/`: `app.json` / `app.config.ts`, `eas.json`, `package.json`, `assets/`, and `scripts/`.
